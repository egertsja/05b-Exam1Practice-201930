...
def problem2a(circle, rectangle, window):
    ...
    corner1=rectangle.get_upper_right_corner()
    corner2=rectangle.get_lower_left_corner()
...
def problem2b(rect, n, delta, win):
    ...
    rect.attach_to(win)
    for _ in range(n):
        rect=rg.Rectangle(rect.corner_1,rect.corner_2)
        rect.corner_1.x = rect.corner_1.x-delta
        rect.corner_1.y = rect.corner_1.y - delta
        rect.corner_2.x = rect.corner_2.x + delta
        rect.corner_2.y = rect.corner_2.y + delta
        rect.attach_to(win)
    win.render()
